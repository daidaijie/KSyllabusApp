package com.daijie.ksyllabusapp.widgets.scroll_choice;
...
public abstract class WheelPicker extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int resultHeight = mTextMaxHeight * mVisibleItemCount + mItemSpace * (mVisibleItemCount - 1) + 320;
...
//                Logger.e("drawnDataPos: " + drawnDataPos + ", drawnOffsetPos: " + drawnOffsetPos +
//                        ", selectedItemPosition: " + selectedItemPosition + ", data : " + data);
                canvas.save();
